...
public class Single_Label 
{
	public static void main(String[] args) throws IOException 
	{
		...
		ss.put(6,"compare");
		ss.put(7,"contradict");
		String SAMPLE_CSV_FILE = "E:\\workspace\\Citation_Java\\src\\pro\\Single.csv";
        ...
        String[] headerRecord = {"Year", "File Name", "Title", "Citation Count","Labeled"};
			...
			for (String file : files)
			{
				...
				if(temp==1)
				{
					...
					try 
				    {
			            ...
			            if(rs.next())
			            {
			                csvWriter.writeNext(new String[]{rs.getString("Year"), rs.getString("FileName"), rs.getString("Title"), rs.getString("Citation_Count"), line_level.replace(",", " ")});
			            }
			            con.close();
					}
				    catch (Exception e) 
